...
NONSPOILER_VERSION_FOR_SPOILER_TEMPLATES = [
    "{TEAM_NAME_1} vs {TEAM_NAME_2} {LEAGUE_NAME} {SEASON}",
    "Highlights {TEAM_NAME_1} vs {TEAM_NAME_2} {LEAGUE_NAME} {SEASON}",
    "{TEAM_NAME_1} vs {TEAM_NAME_2} Highlights {LEAGUE_NAME} {SEASON}",
    "{TEAM_NAME_1} vs {TEAM_NAME_2} {LEAGUE_NAME} {SEASON}",
    "{TEAM_NAME_1} vs {TEAM_NAME_2} {LEAGUE_NAME}",
    "{LEAGUE_NAME} {TEAM_NAME_1} vs {TEAM_NAME_2}",
    "Resumen de {TEAM_NAME_1} vs {TEAM_NAME_2} {LEAGUE_NAME} {SEASON}",
    "Resumen de {TEAM_NAME_1} vs {TEAM_NAME_2} {LEAGUE_NAME} {SEASON}",
    "{TEAM_NAME_1} vs. {TEAM_NAME_2} in the {LEAGUE_NAME} - Julien  | ESPN FC", 
    "{TEAM_NAME_1} vs. {TEAM_NAME_2} in the {LEAGUE_NAME} - ESPN FC", 
    "{TEAM_NAME_1}-{TEAM_NAME_2} | Goals & Highlights | Serie A 2022/23",
    "HIGHLIGHTS | {TEAM_NAME_1} vs {TEAM_NAME_2}", 
    "{TEAM_NAME_1} vs {TEAM_NAME_2} | {LEAGUE_NAME} Highlights",
    "HIGHLIGHTS: {TEAM_NAME_1} vs {TEAM_NAME_2} | {PLACE_1}!",
    "HIGHLIGHTS | {TEAM_NAME_1} v {TEAM_NAME_2}",
    "Extended Highlights | {TEAM_NAME_1} vs {TEAM_NAME_2}",
    "Extended Highlights | {TEAM_NAME_1} vs {TEAM_NAME_2}",
    "Extended Highlights | {TEAM_NAME_1} vs {TEAM_NAME_2}",
    "Highlights of game at {PLACE_1}",
    "",
    "",
    "",
    "",
